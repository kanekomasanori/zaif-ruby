...
module Zaif
    class API
        ...
        # Issue trade.
        # Need api key.
        def trade(currency_code, price, amount, action, comment = nil, limit = nil, counter_currency_code = "jpy")
        ...
        # Issue bid order.
        # Need api key.
        def bid(currency_code, price, amount, comment = nil, limit = nil, counter_currency_code = "jpy")
            return trade(currency_code, price, amount, "bid", comment, limit, counter_currency_code)
        end

        # Issue ask order.
        # Need api key.
        def ask(currency_code, price, amount, comment = nil, limit = nil, counter_currency_code = "jpy")
            return trade(currency_code, price, amount, "ask", comment, limit, counter_currency_code)
        end
